...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2025 at 10:09 PM
...
(6, 'PIN', 'Tu', 'instructor@gmail.com', 'instructor', 'Female', 'scrypt:32768:8:1$zBTKTEERcHaUHLtz$138f13bcafffe559ac5c294ffa493f010e93b3294351e8b48ee76910a2f58afc555df4ae45e2dc50ae9ee7b69e5fecb8cb79c3b590d4708e65ad93572a9d7ffc', 'instructor', '0944334433', '6_20250807145903_kk.png'),
...
(8, 'pin', 'pinpin', 'pin@gmail.com', 'pin', 'Female', 'scrypt:32768:8:1$jIhGmIPfKkC0CT75$c42d1e5c7a137be7290f64f03b1eee4869393c710534f25d066f70ff7dd07160d3b00a000c52237e0627104f8b27543566de8d2934736f5928f087b2f00dec6e', 'instructor', '0977654443', NULL);
...
(19, 42, 1, 'ข้อใดคือองค์ประกอบของความมั ่นคงสารสนเทศ (CIA Triad)?', 'Control, Integrity, Accuracy ', 'Confidentiality, Integrity, Availability', 'Communication, Innovation, Access ', ' Compliance, Information, Audit ', 'b', '', '', '', '', ''),
(20, 42, 1, 'ข้อใดอธิบายคำว่า Threat ได้ถูกต้องที่สุด? ', ' ช่องโหว่ในระบบ', 'วิธีการที่ใช้ป้องกันข้อมูล', ' ความเสี่ยงทางการเงิน', 'สงทที่อาจก่อให้เกิดอันตรายต่อระบบ ', 'd', '', '', '', '', ''),
(26, 42, 1, 'คำว่า Vulnerability หมายถึงอะไรในระบบความมนั่ คงสารสนเทศ?', 'ช่องทางการสื่อสาร', 'ช่องโหว่หรือจุดอ่อนของระบบ', 'วิธีเข้ารหัสข้อมูล', 'วิธีเข้าถึงระบบอย่างถูกต้อง', 'b', '', '', '', '', ''),
(27, 42, 1, 'ความเสี่ยง (Risk) เกิดจากอะไร?', 'การใช้ซอฟต์แวร์ของแท', 'ความเป็นไปได้ของภัยคุกคามที่ใช้ช่องโหว่', 'การอัปเดตระบบสม ่าเสมอ', 'ระบบที่มีประสิทธิภาพ', 'b', '', '', '', '', ''),
...
(69, 42, 1, 'ข้อใดไม่ใช่ประเภทของ Security Control?', 'Physical Control ', 'Administrative Control', 'Technical Control', ' Financial Control', 'd', '', '', '', '', ''),
(70, 42, 1, 'Firewall ท าหน้าที่อะไร?', 'ตรวจสอบความเร็วอินเทอร์เน็ต', 'ป้องกันการเข้าถึงเครือข่ายโดยไม่ได้รับอนุญาต', 'เข้ารหัสข้อมูลทั ้งหมด', 'บันทึกการใช้งานเว็บไซต์ ', 'b', '', '', '', '', ''),
(71, 42, 1, 'ข้อใดคือความแตกต่างหลักระหว่าง IDS และ IPS?', 'IDS ป้องกันไวรัส, IPS ตรวจสอบอินเทอร์เน็ต', 'IDS ตรวจจับ, IPS ป้องกัน', 'IDS เก็บข้อมูล, IPS สร้างรหัสผ่าน', 'IDS คือฮาร์ดแวร์, IPS คือซอฟต์แวร์ ', 'b', '', '', '', '', ''),
(72, 42, 1, 'Public Key ใช้ท าอะไร? ', 'ถอดรหัสข้อมูล', 'ใช้เพื่อเก็บข้อมูลสำรอง', 'เข้ารหัสเพื่อส่งข้อมูล ', 'แสดงชื่อผู ้ใช้ในระบบ ', 'c', '', '', '', '', ''),
(73, 42, 1, 'ข้อใดเป็นความสามารถของ Anti-malware?', 'ป้องกันไวรัสเท่านัน', 'ป้องกันมัลแวร์ทุกรูปแบบ', 'ป้องกันเฉพาะโฆษณา', 'ใช้สำหรับจัดการบัญชีผู ้ใช', 'b', '', '', '', '', ''),
(74, 42, 1, 'ข้อใดคือประโยชน์ของ VPN? ', 'เพิ ่มความเร็วเน็ต', 'สร้างไฟล์ส ารอง', 'ปกป้องข้อมูลระหว่างส่งผ่านเครือข่าย ', 'ลดค่าใช้จ่ายระบบ', 'c', '', '', '', '', ''),
(75, 43, 1, 'ข้อใดคือองค์ประกอบของความมั ่นคงสารสนเทศ (CIA Triad)?', 'Control, Integrity, Accuracy', 'Confidentiality, Integrity, Availability', 'Communication, Innovation, Access', 'Compliance, Information, Audit', 'b', '', '', '', '', ''),
(76, 43, 1, 'ข้อใดอธิบายคำว่า Threat ได้ถูกต้องที่สุด?', 'ช่องโหว่ในระบบ', 'วิธีการที่ใช้ป้องกันข้อมูล', 'ความเสี่ยงทางการเงิน', 'สิ ่งที่อาจก่อให้เกิดอันตรายต่อระบบ', 'd', '', '', '', '', ''),
(77, 43, 1, 'คำว่า Vulnerability หมายถึงอะไรในระบบความมั่นคงสารสนเทศ?', 'ช่องทางการสื่อสาร', 'ช่องโหว่หรือจุดอ่อนของระบบ', 'วิธีเข้ารหัสข้อมูล', 'วิธีเข้าถึงระบบอย่างถูกต้อง', 'b', '', '', '', '', ''),
(78, 43, 1, 'ความเสี่ยง (Risk) เกิดจากอะไร?', 'การใช้ซอฟต์แวร์ของแท', 'ความเป็นไปได้ของภัยคุกคามที่ใช้ช่องโหว', 'การอัปเดตระบบสม่ำเสมอ', 'ระบบที่มีประสิทธิภาพ', 'b', '', '', '', '', ''),
(79, 43, 1, 'ข้อใดไม่ใช่ประเภทของ Security Control? ', 'Physical Control ', 'Administrative Control ', 'Technical Control ', 'Financial Control ', 'd', '', '', '', '', ''),
(80, 43, 1, 'Firewall ท าหน้าที่อะไร? ', 'ตรวจสอบความเร็วอินเทอร์เน็ต', 'ป้องกันการเข้าถึงเครือข่ายโดยไม่ได้รับอนุญาต', 'เข้ารหัสข้อมูลทั้งหมด', 'บันทึกการใช้งานเว็บไซต์ ', 'b', '', '', '', '', ''),
(81, 43, 1, 'ข้อใดคือความแตกต่างหลักระหว่าง IDS และ IPS?', 'IDS ป้องกันไวรัส, IPS ตรวจสอบอินเทอร์เน็ต ', 'IDS ตรวจจับ, IPS ป้องกัน', 'IDS เก็บข้อมูล, IPS สร้างรหัสผ่าน ', 'IDS คือฮาร์ดแวร์, IPS คือซอฟต์แวร์', 'b', '', '', '', '', ''),
(82, 43, 1, 'Public Key ใช้ทำอะไร? ', 'ถอดรหัสข้อมูล', 'ใช้เพื่อเก็บข้อมูลส ารอง', 'เข้ารหัสเพื่อส่งข้อมูล', 'แสดงชื่อผู ้ใช้ในระบบ', 'c', '', '', '', '', ''),
(83, 43, 1, 'ข้อใดเป็นความสามารถของ Anti-malware? ', 'ป้องกันไวรัสเท่านั ้น', 'ป้องกันมัลแวร์ทุกรูปแบบ ', 'ป้องกันเฉพาะโฆษณา ', 'ใช้สำหรับจัดการบัญชีผู ้ใช', 'b', '', '', '', '', ''),
(84, 43, 1, 'ข้อใดคือประโยชน์ของ VPN?  ', 'เพิ่มความเร็วเน็ต', 'สร้างไฟล์สำรอง', 'ปกป้องข้อมูลระหว่างส่งผ่านเครือข่าย', 'ลดค่าใช้จ่ายระบบ', 'd', '', '', '', '', ''),
(85, 44, 1, 'วงจรการพัฒนาระบบความมั ่นคงมีลักษณะอย่างไร? ', 'แบบเส้นตรง ', 'แบบไม่แน่นอน ', 'แบบวงกลมต่อเนื่อง ', 'แบบกลุ ่มซ้อนกัน ', 'c', '', '', '', '', ''),
(86, 44, 1, 'การฝึกอบรมผู ้ใช้งานในระบบใหม่ มีจุดประสงค์ใด?', 'ลดค่าใช้จ่าย', 'ให้ผู ้ใช้รู ้วิธีใช้ระบบอย่างปลอดภัย ', 'เพิ่มการขาย ', 'ลดการใช้ไฟฟ้า', 'b', '', '', '', '', ''),
(87, 44, 1, 'การปรับปรุงและบ ารุงรักษาระบบมีวัตถุประสงค์ใด? ', 'ปรับเปลี่ยนโลโก้ ', 'เพิ่มลูกเล่นใหม่ ', 'ป้องกันและแก้ไขช่องโหว่ที่เกิดขึ ้น', 'เพิ่มสีสันในระบบ', 'c', '', '', '', '', ''),
(88, 44, 1, 'การจัดท าเอกสารระบบความมั ่นคงมีประโยชน์ใด?', 'เพื่อการโฆษณา', 'เพื่อการจัดซื ้ออุปกรณ์ ', 'เพื่อให้ทีมงานสามารถตรวจสอบและบ ารุงรักษาได้ ', 'เพื่อท ารายงานการเงิน ', 'c', '', '', '', '', ''),
(89, 44, 1, 'การระบุความต้องการด้านความมั ่นคงควรรวมสิ่งใดบ้าง? ', 'งบประมาณของโครงการ ', 'ความต้องการของผู ้ใช้งานและข้อก าหนดด้านความปลอดภัย ', 'ลักษณะหน้าจอโปรแกรม ', 'รายชื ่อผู ้พัฒนา', 'b', '', '', '', '', ''),
(90, 45, 1, 'วงจรการพัฒนาระบบความมั ่นคงมีลักษณะอย่างไร?', 'แบบเส้นตรง', 'แบบไม่แน่นอน', 'แบบวงกลมต่อเนื ่อง ', 'แบบกลุ่มซ้อนกัน ', 'c', '', '', '', '', ''),
(91, 45, 1, 'การฝึกอบรมผู ้ใช้งานในระบบใหม่ มีจุดประสงค์ใด?', 'ลดค่าใช้จ่าย ', 'ให้ผู ้ใช้รู ้วิธีใช้ระบบอย่างปลอดภัย ', 'เพิ่มการขาย', 'ลดการใช้ไฟฟ้า ', 'b', '', '', '', '', ''),
(92, 45, 1, 'การปรับปรุงและบ ารุงรักษาระบบมีวัตถุประสงค์ใด? ', 'ปรับเปลี่ยนโลโก้ ', 'เพิ่มลูกเล่นใหม่ ', 'ป้องกันและแก้ไขช่องโหว่ที่เกิดขึ ้น', 'เพิ่มสีสันในระบบ', 'c', '', '', '', '', ''),
(93, 45, 1, 'การจัดท าเอกสารระบบความมั ่นคงมีประโยชน์ใด?', 'เพื่อการโฆษณา', 'เพื่อการจัดซื ้ออุปกรณ์ ', 'เพื่อให้ทีมงานสามารถตรวจสอบและบ ารุงรักษาได้', 'เพื่อท ารายงานการเงิน ', 'c', '', '', '', '', ''),
(94, 45, 1, 'การระบุความต้องการด้านความมั ่นคงควรรวมสิ่งใดบ้าง?', 'งบประมาณของโครงการ', 'ความต้องการของผู ้ใช้งานและข้อก าหนดด้านความปลอดภัย ', 'ลักษณะหน้าจอโปรแกรม', 'รายชื ่อผู ้พัฒนา ', 'b', '', '', '', '', ''),
(95, 46, 1, 'อัลกอริธึมใดต่อไปนี ้เป็นการเข้ารหัสแบบสมมาตร? ', 'RSA', 'DES ', 'ECC ', 'DSA ', 'b', '', '', '', '', ''),
(96, 46, 1, 'ข้อใดแสดงต าแหน่งของ Firewall บนโครงสร้างเครือข่ายได้ถูกต้อง?', 'วางหลัง Router', 'วางหน้าผู ้ใช้งาน', 'วางระหว่างเครือข่ายภายในและภายนอก', 'วางในเครื่องผู ้ใช้ ', 'c', 'Screenshot_2025-10-16_020437.png', '', '', '', ''),
(97, 46, 1, 'SSL/TLS ท าหน้าที ่ใดในกระบวนการสื ่อสารออนไลน์?', 'ลดเวลาโหลดเว็บไซต์ ', 'ป้องกันการเข้าถึงข้อมูลจากบุคคลที่สาม ', 'ท าให้เว็บสวยงามขึ ้น', 'บีบอัดข้อมูลเว็บไซต์ ', 'b', '', '', '', '', ''),
(98, 46, 1, 'ข้อใดเป็นความแตกต่างระหว่าง Symmetric และ Asymmetric Encryption? ', 'Symmetric ใช้ 2 คีย์ ส่วน Asymmetric ใช้คีย์เดียว ', 'Asymmetric ใช้ Public/Private Key คู ่กัน ส่วน Symmetric ใช้คีย์เดียว ', 'ไม่มีความแตกต่าง ', ' Symmetric ไม่ใช้คีย์ใดๆ', 'b', '', '', '', '', ''),
(99, 46, 1, 'การเข้ารหัสที ่มีความเร็วสูงและเหมาะส าหรับปริมาณข้อมูลมากคือแบบใด?', 'Asymmetric', 'Symmetric', 'Hashing ', 'Two-Factor ', 'b', '', '', '', '', ''),
(100, 47, 1, 'ข้อใดกล่าวถึงวัตถุประสงค์หลักของการเข้ารหัสข้อมูล (Encryption) ได้ถูกต้องที ่สุด?', 'ท าให้ไฟล์มีขนาดเล็กลง', ' ป้องกันไวรัสเข้าสู ่ระบบ ', 'รักษาความลับของข้อมูลขณะส่งผ่านเครือข่าย ', ' ลดความซับซ้อนของข้อมูล', 'c', '', '', '', '', ''),
(101, 47, 1, 'การเข้ารหัสแบบ Symmetric Encryption มีลักษณะเด่นคืออะไร? ', 'ช้คีย์ 2 ชุด', 'ใช้รหัสผ่านที่แตกต่างในการเข้ารหัสและถอดรหัส ', 'ใช้คีย์เดียวกันในการเข้ารหัสและถอดรหัส', 'ไม่สามารถถอดรหัสได้ ', 'c', '', '', '', '', ''),
(102, 47, 1, 'อัลกอริธึมการเข้ารหัสแบบไม่สมมาตร (Asymmetric Encryption) ใช้คีย์กี ่ชุด? ', '1 ชุด', ' 2 ชุด คือ Public Key และ Private Key', '3 ชุด ', 'ไม่มีการใช้คีย', 'b', '', '', '', '', ''),
(103, 47, 1, 'ข้อใดคือตัวอย่างของการใช้งาน Public Key ในชีวิตจริง?', 'การตั้งรหัสผ่าน Wi-Fi ', 'การสแกนลายนิ ้วมือ', 'การยืนยันตัวตนผ่าน HTTPS บนเว็บไซต์ ', 'การใช้ Antivirus ', 'c', '', '', '', '', ''),
(104, 47, 1, 'ข้อใดคือลักษณะของ Hash Function? ', 'ท าให้ข้อความกลับมาเหมือนเดิมได้ ', 'ใช้ส าหรับเข้ารหัสลับ', 'แปลงข้อมูลเป็นค่าคงที่ที่ไม่สามารถย้อนกลับได', 'ใช้ถอดรหัสข้อความ', 'c', '', '', '', '', ''),
(105, 48, 1, 'ข้อใดเป็นความรับผิดชอบของผู้ใช้งานระบบสารสนเทศตามจริยธรรม?', 'ละเมิดข้อมูลของผู ้อื่นเพื่อผลประโยชน์ส่วนตัว ', 'ใช้เทคโนโลยีเพื่อช่วยพัฒนาสังคมและปฏิบัติตามกฎหมาย', 'เปิดเผยรหัสผ่านของผู ้อื่นโดยไม่อนุญาต ', 'ใช้ซอฟต์แวร์เถื ่อนอย่างเปิดเผย', 'b', '', '', '', '', ''),
(106, 48, 1, ' ข้อใดไม่ถือเป็นการละเมิดสิทธิ ์ตามกฎหมายคอมพิวเตอร์?', 'การเจาะระบบฐานข้อมูลของบริษัท', 'การใช้งานซอฟต์แวร์ลิขสิทธิ ์อย่างถูกต้อง', 'การส่งอีเมลขยะ (Spam) ', 'การปลอมแปลงข้อมูลออนไลน์ ', 'b', '', '', '', '', ''),
(107, 48, 1, 'ข้อใดคือแนวทางปฏิบัติที ่ถูกต้องในการรักษาความมั ่นคงของข้อมูลส่วนบุคคล? ', 'แชร์รหัสผ่านกับเพื่อน', ' ไม่เปิดเผยข้อมูลส่วนตัวในที่สาธารณะโดยไม่จ าเป็น ', 'ส่งข้อมูลส่วนตัวผ่านอีเมลที่ไม่ปลอดภัย ', 'ใช้รหัสผ่านง่าย ๆ เช่น \"123456\"', 'b', '', '', '', '', ''),
(108, 48, 1, ' การใช้เทคโนโลยีสารสนเทศโดยค านึงถึงผลกระทบทางสังคมและสิ ่งแวดล้อมเป็นหลักการของข้อใด?', 'ความรับผิดชอบทางจริยธรรม ', 'การละเมิดลิขสิทธิ ์ ', 'การแฮกข้อมูล ', 'การละเมิดความเป็นส่วนตัว ', 'a', '', '', '', '', ''),
(109, 48, 1, 'ข้อใดคือผลที ่อาจเกิดขึ ้นจากการละเมิดกฎหมายคอมพิวเตอร์? ', 'การได้รับรางวัล', 'การถูกด าเนินคดีทางกฎหมายและโทษทางอาญา', 'การได้รับการยกย่อง', 'ไม่มีผลกระทบใด ๆ ', 'b', '', '', '', '', ''),
(110, 49, 1, ' ข้อใดเป็นวัตถุประสงค์หลักของกฎหมายคอมพิวเตอร์? ', 'ส่งเสริมการละเมิดลิขสิทธิ ์ ', 'ปกป้องข้อมูลและความเป็นส่วนตัวของผู ้ใช้', 'สนับสนุนการโจมตีทางไซเบอร์ ', 'ท าลายข้อมูลในระบบ ', 'b', '', '', '', '', ''),
(111, 49, 1, 'ข้อใดถือเป็นการกระท าผิดตามกฎหมายคอมพิวเตอร์? ', 'การเผยแพร่ไวรัสคอมพิวเตอร์ ', 'การส่งอีเมลทักทายเพื่อน ', 'การใช้ซอฟต์แวร์ลิขสิทธิ ์อย่างถูกต้อง', 'การส ารองข้อมูลส่วนตัว ', 'a', '', '', '', '', ''),
(112, 49, 1, 'หลักจริยธรรมที ่ส าคัญในการใช้เทคโนโลยีสารสนเทศคือข้อใด?', 'การลอกข้อมูลจากผู ้อื่น ', 'การใช้ข้อมูลอย่างรับผิดชอบและเคารพสิทธิผู ้อื่น', 'การแฮกข้อมูลเพื่อความสนุกสนาน', 'การเผยแพร่ข้อมูลเท็จ', 'b', '', '', '', '', ''),
(113, 49, 1, 'ข้อใดคือหลักการ “ความเป็นส่วนตัว” ในระบบสารสนเทศ? ', 'เปิดเผยข้อมูลของผู ้อื่นโดยไม่ได้รับอนุญาต', 'ปกป้องข้อมูลส่วนบุคคลไม่ให้ถูกเข้าถึงโดยไม่ได้รับอนุญาต ', 'การเข้าถึงข้อมูลทั ้งหมดในระบบได้โดยเสรี ', 'การละเมิดข้อมูลส่วนตัว', 'b', '', '', '', '', ''),
(114, 49, 1, 'พ.ร.บ. คอมพิวเตอร์ พ.ศ. 2560 ในประเทศไทยเน้นเรื ่องใดเป็นส าคัญ?', 'การสนับสนุนการโจมตีไซเบอร์ ', 'การควบคุมและป้องกันการกระท าผิดทางคอมพิวเตอร์ ', ' การส่งเสริมการลอกเลียนแบบข้อมูล ', 'การสนับสนุนการละเมิดลิขสิทธิ ์ ', 'b', '', '', '', '', ''),
(115, 50, 1, 'ข้อใดไม่ใช่ส่วนประกอบหลักของ IDS?', 'Sensor (ตัวเก็บข้อมูล)', ' Analyzer (ตัววิเคราะห์ข้อมูล) ', 'Reporter (ตัวรายงานผล) ', ' Firewall (ก าแพงป้องกัน) ', 'd', '', '', '', '', ''),
(116, 50, 1, 'ระบบ IDS ใดที ่ติดตั ้งบนเครื ่องเซิร์ฟเวอร์เพื ่อป้องกันเครื ่องนั ้นโดยเฉพาะ? ', 'Network-based IDS (NIDS) ', ' Host-based IDS (HIDS) ', 'Firewall ', 'Proxy Server ', 'b', '', '', '', '', ''),
(117, 50, 1, ' ข้อใดคือความแตกต่างหลักระหว่าง Network-based IDS และ Host-based IDS? ', 'NIDS ตรวจสอบข้อมูลในเครือข่ายโดยรวม ส่วน HIDS ตรวจสอบในเครื่องเดียว ', 'NIDS ใช้ตรวจจับไวรัส ส่วน HIDS ใช้ตรวจจับสแปม', 'NIDS ใช้ส าหรับการส ารองข้อมูล ส่วน HIDS ใช้ส าหรับการเข้ารหัส ', 'ไม่มีความแตกต่าง ', 'a', '', '', '', '', ''),
(118, 50, 1, 'การแจ้งเตือนที ่ผิดพลาด (False Positive) หมายถึงอะไร?', 'การแจ้งเตือนเมื่อไม่มีการบุกรุกเกิดขึ ้นจริง ', 'การไม่แจ้งเตือนเมื่อมีการบุกรุกจริง ', 'การแจ้งเตือนถูกต้องทุกครั ้ง', ' การปิดระบบโดยอัตโนมัต', 'a', '', '', '', '', ''),
(119, 50, 1, 'ข้อใดเป็นตัวอย่างของการตอบสนองหลังจาก IDS ตรวจจับการบุกรุก?', 'การแจ้งเตือนผู ้ดูแลระบบ', 'การเพิ่มความเร็วอินเทอร์เน็ต ', 'การลบข้อมูลทั ้งหมด ', 'การปิดระบบเครือข่ายถาวร ', 'a', '', '', '', '', ''),
(120, 51, 1, 'Intrusion Detection System (IDS) คืออะไร? ', 'ระบบที่ป้องกันไวรัส ', 'ระบบที่ตรวจจับและแจ้งเตือนการบุกรุกในระบบเครือข่าย', 'ระบบส ารองข้อมูลอัตโนมัต', 'ระบบจัดเก็บข้อมูล ', 'b', '', '', '', '', ''),
(121, 51, 1, 'IDS แบบใดที ่ตรวจจับการบุกรุกโดยเปรียบเทียบพฤติกรรมกับลายเซ็นที ่รู ้จัก? ', 'Anomaly-based IDS', 'Signature-based IDS', 'Hybrid IDS ', 'Firewall ', 'b', '', '', '', '', ''),
(122, 51, 1, 'ข้อใดคือข้อดีของ Signature-based IDS?', 'สามารถตรวจจับภัยใหม่ที่ไม่เคยรู ้จักได้ดี ', ' มีความแม่นย าสูงส าหรับภัยที่รู ้จัก ', 'ไม่ต้องการอัปเดตฐานข้อมูลลายเซ็น', 'ใช้งานง่ายโดยไม่ต้องตั้งค่า', 'b', '', '', '', '', ''),
(123, 51, 1, 'IDS แบบใดที ่ตรวจจับการบุกรุกโดยการวิเคราะห์พฤติกรรมที ่ผิดปกติจากปกติ?', 'Signature-based IDS ', 'Anomaly-based IDS', 'Firewall ', 'Proxy Server ', 'b', '', '', '', '', ''),
(124, 51, 1, 'ข้อใดเป็นข้อจ ากัดของ Anomaly-based IDS?', 'ไม่สามารถตรวจจับภัยที่รู ้จักได้ ', 'มีโอกาสแจ้งเตือนผิดพลาดสูง (False Positive) ', 'ไม่ต้องการอัปเดตฐานข้อมูล ', 'ตรวจจับได้เร็วกว่า Signature-based IDS เสมอ ', 'b', '', '', '', '', '');
...
INSERT INTO `quiz_video` (`video_id`, `title`, `youtube_link`, `video_file`, `description`, `time_duration`, `preview`, `video_image`, `quiz_id`, `lesson_id`) VALUES
(62, 'Pre-test', '', NULL, NULL, NULL, NULL, NULL, 42, 6),
(63, 'บทที่1 แบบทดสอบพื้นฐานความมั่นคงของระบบสารสนเทศ', 'https://youtu.be/Coh7oRmw9cs?si=dupdGug80EGq3r29', NULL, 'Information System Security | หน่วยที่ 1 ความรู้พื้นฐานเกี่ยวกับความมั่นคงของระบบสารสนเทศ\r\n', '11:21', NULL, '', NULL, 6),
(64, 'Post-test', '', NULL, NULL, NULL, NULL, NULL, 43, 6),
(65, 'Pre-test', '', NULL, NULL, NULL, NULL, NULL, 44, 7),
(66, 'บทที่2 วงจรการพัฒนาระบบความมั ่นคงของระบบสารสนเทศ', 'https://youtu.be/6FGpjd485c4?si=ZKkXuvI_Ty3yB9cg', NULL, '', '17:41', NULL, '', NULL, 7),
(67, 'Post-test', '', NULL, NULL, NULL, NULL, NULL, 45, 7),
(68, 'Pre-test', '', NULL, NULL, NULL, NULL, NULL, 46, 8),
(69, 'หน่วยที่3 วิธีการและเทคนิครักษาความมั ่นคงของระบบ  สารสนเทศ', 'https://youtu.be/Nh5npqoTLLQ?si=8S8oIQI3ALCxclJY', NULL, '', '17:20', NULL, '', NULL, 8),
(70, 'Post-test', '', NULL, NULL, NULL, NULL, NULL, 47, 8),
(71, 'Pre-test', '', NULL, NULL, NULL, NULL, NULL, 48, 9),
(72, 'หน่วยที่4 นโยบายในการสร้างความมั ่นคงของระบบสารสนเทศ', 'https://youtu.be/RceFsg0h_Zw?si=QzJ1oLMaQhXSV7P3', NULL, '', '8:01', NULL, '', NULL, 9),
(73, 'Post-test', '', NULL, NULL, NULL, NULL, NULL, 49, 9),
(74, 'Pre-test', '', NULL, NULL, NULL, NULL, NULL, 50, 11),
(75, 'หน่วยที่5 กลไกในการสร้างความปลอดภัยและเครื ่องมือช่วยใน  การสร้างมั่นคงของระบบสารสนเทศ', 'https://youtu.be/oPPN7Q6DEvg?si=i2iFDNzCgRrWWhCf', NULL, '', '5:01', NULL, '', NULL, 11),
(76, 'Post-test', '', NULL, NULL, NULL, NULL, NULL, 51, 11);
...
(34, 'pond', 'athittanat', 'qwer@gmail.com', 'user', '1160601167094', '', 'scrypt:32768:8:1$NUevnNNTHXSBUFvB$74d34d9e28b8030da208d104ba294a9c8e4c538b0385f874dcb2408e5eb49ce944735c159b00df4bd2a902b0289bb571a2fbbc37c6b57f82bf6029a6435bd253', 'user', '2025-06-09 09:41:39', '34_20250731135048_gg.png', '0987676789'),
