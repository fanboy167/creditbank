...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2025 at 08:48 PM
...
ALTER TABLE `user_quiz_attempts`
  ...
  ADD CONSTRAINT `fk_attempts_user_relation` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `user_video_progress`
--
ALTER TABLE `user_video_progress`
  ADD CONSTRAINT `fk_progress_user_relation` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
